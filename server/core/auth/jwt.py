...
def new_jwt(user_id, user_email, token_expiration_seconds, jwt_secret):
    ...
    if user_email in ["dsmurrell@gmail.com", "pavan@4ngenehealth.com"]:
        role = "researcher"

    if user_email in [
        "dsmurrell@protonmail.com",
        "liam@sanogenetics.com",
        "paul.wicks@sanogenetics.com",
        "paul@wicksdigitalhealth.com",
        "ross@sanogenetics.com",
        "alex@sanogenetics.com",
        "ben@sanogenetics.com",
    ]:
        role = "team"
    ...
    if user_email in [
        ...
        "charlotte@sanogenetics.com",
        "joe@sanogenetics.com",
        "adam@sanogenetics.com",
        "hamzah@sanogenetics.com",
        "clare@sanogenetics.com",
        "georgia@sanogenetics.com",
    ]:
        role = "admin"
